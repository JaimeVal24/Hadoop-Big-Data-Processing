...
This project implements a big data pipeline to analyze wildfire occurrences in the United States using **Apache Hadoop** and **Apache Spark**. It processes large-scale datasets to identify spatial and temporal trends in fire intensity—specifically **Fire Radiative Power (FRP)**—across California counties.
